...
const seed_db = async () => {
    ...
    try {
        ...
        testUser = await factory.create("user2", { password: testUserPassword });
        await factory.createMany("trip2", 20, { createdBy: testUser._id }); // put 30 job entries in the database.
    } catch (e) {
